...
public class SenseiServerBuilder implements SenseiConfParams{
    ...
    public SenseiServer buildServer() throws ConfigurationException {
        ...
        String host = _senseiConf.getString(SERVER_HOST);
        ...
        return new SenseiServer(host, port,networkServer,clusterClient,core,svcList, pluginRegistry);
