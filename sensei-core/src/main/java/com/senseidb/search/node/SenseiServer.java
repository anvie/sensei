...
//    private final CoreSenseiServiceImpl _innerSvc;
  private final List<AbstractSenseiCoreService<AbstractSenseiRequest, AbstractSenseiResult>> _externalSvc;
    ...
    public SenseiServer(int id, String defaultHost, int port, int[] partitions,
    ...
    {
        this(defaultHost, port,networkServer,clusterClient,new SenseiCore(id, partitions,zoieSystemFactory, indexingManager, queryBuilderFactory, zoieSystemFactory.getDecorator()),externalSvc, pluginRegistry);
    }

    public SenseiServer(String defaultHost, int port,
                        NetworkServer networkServer,
                        ClusterClient clusterClient,
...
//    SenseiClusterClientImpl senseiClusterClient = new SenseiClusterClientImpl(clusterName, zookeeperURL, zookeeperTimeout, false);
    ...
    private String getLocalIpAddress() throws SocketException,
        ...
        if (_defaultHost != null && _defaultHost.length() > 0){
            return String.format("%s:%d", _defaultHost, _port);
        }
